...
@nogc nothrow:
	...
	{
		__gshared:
		@GodotName("get_default_value") GodotMethod!(Transform) getDefaultValue;
		@GodotName("is_default_value_enabled") GodotMethod!(bool) isDefaultValueEnabled;
		@GodotName("set_default_value") GodotMethod!(void, Transform) setDefaultValue;
	...
	*/
	Transform getDefaultValue() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Transform)(GDNativeClassBinding.getDefaultValue, _godot_object);
	}
	/**
	...
	*/
	void setDefaultValue(in Transform value)
	{
		checkClassBinding!(typeof(this))();
	...
	*/
	@property Transform defaultValue()
	{
		return getDefaultValue();
	}
	/// ditto
	@property void defaultValue(Transform v)
	{
		setDefaultValue(v);
	}
	/**
