...
{
	package(godot) enum string _GODOT_internal_name = "WorldEnvironment";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in WorldEnvironment other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) WorldEnvironment opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of WorldEnvironment.
	/// Note: use `memnew!WorldEnvironment` instead.
