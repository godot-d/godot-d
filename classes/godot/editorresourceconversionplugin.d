...
{
	package(godot) enum string _GODOT_internal_name = "EditorResourceConversionPlugin";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in EditorResourceConversionPlugin other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) EditorResourceConversionPlugin opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of EditorResourceConversionPlugin.
	/// Note: use `memnew!EditorResourceConversionPlugin` instead.
