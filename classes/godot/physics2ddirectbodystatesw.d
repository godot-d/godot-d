...
{
	package(godot) enum string _GODOT_internal_name = "Physics2DDirectBodyStateSW";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in Physics2DDirectBodyStateSW other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) Physics2DDirectBodyStateSW opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of Physics2DDirectBodyStateSW.
	/// Note: use `memnew!Physics2DDirectBodyStateSW` instead.
