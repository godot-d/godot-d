...
{
	package(godot) enum string _GODOT_internal_name = "CapsuleShape";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in CapsuleShape other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) CapsuleShape opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of CapsuleShape.
	/// Note: use `memnew!CapsuleShape` instead.
