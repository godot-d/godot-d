...
@nogc nothrow:
	...
	package(godot) static struct GDNativeClassBinding
	{
		...
		@GodotName("get_filter_baking_aabb") GodotMethod!(AABB) getFilterBakingAabb;
		@GodotName("get_filter_baking_aabb_offset") GodotMethod!(Vector3) getFilterBakingAabbOffset;
		...
		@GodotName("get_parsed_geometry_type") GodotMethod!(NavigationMesh.ParsedGeometryType) getParsedGeometryType;
		...
		@GodotName("get_sample_partition_type") GodotMethod!(NavigationMesh.SamplePartitionType) getSamplePartitionType;
		@GodotName("get_source_geometry_mode") GodotMethod!(NavigationMesh.SourceGeometryMode) getSourceGeometryMode;
		...
		@GodotName("set_filter_baking_aabb") GodotMethod!(void, AABB) setFilterBakingAabb;
		@GodotName("set_filter_baking_aabb_offset") GodotMethod!(void, Vector3) setFilterBakingAabbOffset;
	...
	/// 
	enum SourceGeometryMode : int
	{
		/** */
		sourceGeometryNavmeshChildren = 0,
		/** */
	...
	*/
	AABB getFilterBakingAabb() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(AABB)(GDNativeClassBinding.getFilterBakingAabb, _godot_object);
	}
	/**
	
	*/
	Vector3 getFilterBakingAabbOffset() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Vector3)(GDNativeClassBinding.getFilterBakingAabbOffset, _godot_object);
	}
	/**
	...
	*/
	NavigationMesh.ParsedGeometryType getParsedGeometryType() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(NavigationMesh.ParsedGeometryType)(GDNativeClassBinding.getParsedGeometryType, _godot_object);
	}
	/**
	...
	*/
	NavigationMesh.SamplePartitionType getSamplePartitionType() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(NavigationMesh.SamplePartitionType)(GDNativeClassBinding.getSamplePartitionType, _godot_object);
	}
	/**
	
	*/
	NavigationMesh.SourceGeometryMode getSourceGeometryMode() const
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(NavigationMesh.SourceGeometryMode)(GDNativeClassBinding.getSourceGeometryMode, _godot_object);
	}
	/**
	...
	*/
	void setFilterBakingAabb(in AABB baking_aabb)
	{
		checkClassBinding!(typeof(this))();
		ptrcall!(void)(GDNativeClassBinding.setFilterBakingAabb, _godot_object, baking_aabb);
	}
	/**
	
	*/
	void setFilterBakingAabbOffset(in Vector3 baking_aabb_offset)
	{
		checkClassBinding!(typeof(this))();
		ptrcall!(void)(GDNativeClassBinding.setFilterBakingAabbOffset, _godot_object, baking_aabb_offset);
	}
	/**
	...
	*/
	@property AABB filterBakingAabb()
	{
		return getFilterBakingAabb();
	}
	/// ditto
	@property void filterBakingAabb(AABB v)
	{
		setFilterBakingAabb(v);
	}
	/**
	
	*/
	@property Vector3 filterBakingAabbOffset()
	{
		return getFilterBakingAabbOffset();
	}
	/// ditto
	@property void filterBakingAabbOffset(Vector3 v)
	{
		setFilterBakingAabbOffset(v);
	}
	/**
	...
	*/
	@property bool filterWalkableLowHeightSpans()
	{
		return getFilterWalkableLowHeightSpans();
	}
	/// ditto
	@property void filterWalkableLowHeightSpans(bool v)
	{
	...
	*/
	@property NavigationMesh.ParsedGeometryType geometryParsedGeometryType()
	{
	...
	*/
	@property NavigationMesh.SourceGeometryMode geometrySourceGeometryMode()
	{
	...
	*/
	@property NavigationMesh.SamplePartitionType samplePartitionType()
	{
		return getSamplePartitionType();
	}
	/// ditto
	@property void samplePartitionType(long v)
	{
