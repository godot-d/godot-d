...
{
	package(godot) enum string _GODOT_internal_name = "CylinderShape";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in CylinderShape other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) CylinderShape opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of CylinderShape.
	/// Note: use `memnew!CylinderShape` instead.
