...
@nogc nothrow:
	...
	package(godot) static struct GDNativeClassBinding
	{
		...
		@GodotName("import_scene_from_other_importer") GodotMethod!(Node, String, long, long, long) importSceneFromOtherImporter;
	}
	/// 
	...
	*/
	Node importSceneFromOtherImporter(in String path, in long flags, in long bake_fps, in long compress_flags)
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Node)(GDNativeClassBinding.importSceneFromOtherImporter, _godot_object, path, flags, bake_fps, compress_flags);
	}
}
