...
*/
module godot.navigationobstacle;
...
*/
@GodotBaseClass struct NavigationObstacle
{
	package(godot) enum string _GODOT_internal_name = "NavigationObstacle";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in NavigationObstacle other) const
	...
	mixin baseCasts;
	/// Construct a new instance of NavigationObstacle.
	/// Note: use `memnew!NavigationObstacle` instead.
	static NavigationObstacle _new()
	{
		static godot_class_constructor constructor;
		if(constructor is null) constructor = _godot_api.godot_get_class_constructor("NavigationObstacle");
		if(constructor is null) return typeof(this).init;
		return cast(NavigationObstacle)(constructor());
	}
