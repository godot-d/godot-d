...
{
	enum string _GODOT_internal_name = "VisualShaderNodeScalarDerivativeFunc";
public:
@nogc nothrow:
	...
	bool opEquals(in VisualShaderNodeScalarDerivativeFunc other) const { return _godot_object.ptr is other._godot_object.ptr; }
	VisualShaderNodeScalarDerivativeFunc opAssign(T : typeof(null))(T n) { _godot_object.ptr = null; }
	...
	*/
	VisualShaderNodeScalarDerivativeFunc.Function getFunction() const
	{
		...
		return ptrcall!(VisualShaderNodeScalarDerivativeFunc.Function)(_classBinding.getFunction, _godot_object);
	}
	/**
