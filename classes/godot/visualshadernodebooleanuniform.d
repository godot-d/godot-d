...
@nogc nothrow:
	...
	{
		__gshared:
		@GodotName("get_default_value") GodotMethod!(bool) getDefaultValue;
		@GodotName("is_default_value_enabled") GodotMethod!(bool) isDefaultValueEnabled;
		@GodotName("set_default_value") GodotMethod!(void, bool) setDefaultValue;
	...
	*/
	bool getDefaultValue() const
	{
		...
		return ptrcall!(bool)(GDNativeClassBinding.getDefaultValue, _godot_object);
	}
	/**
	...
	*/
	void setDefaultValue(in bool value)
	{
		checkClassBinding!(typeof(this))();
	...
	*/
	...
	/// ditto
	@property void defaultValue(bool v)
	{
		setDefaultValue(v);
	}
	/**
