...
{
	package(godot) enum string _GODOT_internal_name = "StyleBoxEmpty";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in StyleBoxEmpty other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) StyleBoxEmpty opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of StyleBoxEmpty.
	/// Note: use `memnew!StyleBoxEmpty` instead.
