...
@nogc nothrow:
	...
	package(godot) static struct GDNativeClassBinding
	{
		...
		@GodotName("_property_pinned") GodotMethod!(void, String, bool) _propertyPinned;
	...
	*/
	void _propertyPinned(in String path, in bool pinned)
	{
		Array _GODOT_args = Array.make();
		_GODOT_args.append(path);
		_GODOT_args.append(pinned);
		String _GODOT_method_name = String("_property_pinned");
		this.callv(_GODOT_method_name, _GODOT_args);
	}
	/**
