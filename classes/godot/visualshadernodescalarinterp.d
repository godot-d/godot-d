...
{
	package(godot) enum string _GODOT_internal_name = "VisualShaderNodeScalarInterp";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in VisualShaderNodeScalarInterp other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) VisualShaderNodeScalarInterp opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of VisualShaderNodeScalarInterp.
	/// Note: use `memnew!VisualShaderNodeScalarInterp` instead.
