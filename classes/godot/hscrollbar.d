...
{
	package(godot) enum string _GODOT_internal_name = "HScrollBar";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in HScrollBar other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) HScrollBar opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of HScrollBar.
	/// Note: use `memnew!HScrollBar` instead.
