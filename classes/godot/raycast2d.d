...
RayCast2D can be configured to report collisions with $(D Area2D)s ($(D collideWithAreas)) and/or $(D PhysicsBody2D)s ($(D collideWithBodies)).
...
{
	enum string _GODOT_internal_name = "RayCast2D";
public:
@nogc nothrow:
