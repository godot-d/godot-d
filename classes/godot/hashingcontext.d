...
{
	enum string _GODOT_internal_name = "HashingContext";
public:
@nogc nothrow:
	...
	bool opEquals(in HashingContext other) const { return _godot_object.ptr is other._godot_object.ptr; }
	HashingContext opAssign(T : typeof(null))(T n) { _godot_object.ptr = null; }
	...
	*/
	PoolByteArray finish()
	{
		...
		return ptrcall!(PoolByteArray)(_classBinding.finish, _godot_object);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(GodotError)(_classBinding.start, _godot_object, type);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(GodotError)(_classBinding.update, _godot_object, chunk);
	}
}
