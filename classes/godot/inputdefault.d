...
{
	package(godot) enum string _GODOT_internal_name = "InputDefault";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in InputDefault other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) InputDefault opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of InputDefault.
	/// Note: use `memnew!InputDefault` instead.
