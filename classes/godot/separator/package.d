...
{
	package(godot) enum string _GODOT_internal_name = "Separator";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in Separator other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) Separator opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of Separator.
	/// Note: use `memnew!Separator` instead.
