...
{
	package(godot) enum string _GODOT_internal_name = "AudioEffectEQ6";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in AudioEffectEQ6 other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) AudioEffectEQ6 opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of AudioEffectEQ6.
	/// Note: use `memnew!AudioEffectEQ6` instead.
