...
$(B Kinematic characters:) KinematicBody also has an API for moving objects (the $(D moveAndCollide) and $(D moveAndSlide) methods) while performing collision tests. This makes them really useful to implement characters that collide against a world, but that don't require advanced physics.
*/
...
@nogc nothrow:
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Vector3)(_classBinding.getFloorNormal, _godot_object);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Vector3)(_classBinding.moveAndSlide, _godot_object, linear_velocity, up_direction, stop_on_slope, max_slides, floor_max_angle, infinite_inertia);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		return ptrcall!(Vector3)(_classBinding.moveAndSlideWithSnap, _godot_object, linear_velocity, snap, up_direction, stop_on_slope, max_slides, floor_max_angle, infinite_inertia);
	}
	/**
