...
{
	package(godot) enum string _GODOT_internal_name = "HBoxContainer";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in HBoxContainer other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) HBoxContainer opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of HBoxContainer.
	/// Note: use `memnew!HBoxContainer` instead.
