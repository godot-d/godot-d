...
@nogc nothrow:
	...
	package(godot) static struct GDNativeClassBinding
	{
		...
		@GodotName("_on_replace_in_files_requested") GodotMethod!(void, String) _onReplaceInFilesRequested;
		@GodotName("_open_recent_script") GodotMethod!(void, long) _openRecentScript;
		@GodotName("_prepare_file_menu") GodotMethod!(void) _prepareFileMenu;
		@GodotName("_queue_close_tabs") GodotMethod!(void) _queueCloseTabs;
		...
		@GodotName("_scene_saved_callback") GodotMethod!(void, String) _sceneSavedCallback;
		...
		@GodotName("reload_scripts") GodotMethod!(void) reloadScripts;
	}
	/// 
	...
	*/
	void _onReplaceInFilesRequested(in String arg0)
	{
		Array _GODOT_args = Array.make();
		_GODOT_args.append(arg0);
		String _GODOT_method_name = String("_on_replace_in_files_requested");
		this.callv(_GODOT_method_name, _GODOT_args);
	}
	/**
	...
	*/
	void _prepareFileMenu()
	{
		Array _GODOT_args = Array.make();
		String _GODOT_method_name = String("_prepare_file_menu");
		this.callv(_GODOT_method_name, _GODOT_args);
	}
	/**
	
	*/
	void _queueCloseTabs()
	{
		Array _GODOT_args = Array.make();
		String _GODOT_method_name = String("_queue_close_tabs");
		this.callv(_GODOT_method_name, _GODOT_args);
	}
	/**
	...
	*/
	void _sceneSavedCallback(in String arg0)
	{
		Array _GODOT_args = Array.make();
		_GODOT_args.append(arg0);
		String _GODOT_method_name = String("_scene_saved_callback");
		this.callv(_GODOT_method_name, _GODOT_args);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		ptrcall!(void)(GDNativeClassBinding.reloadScripts, _godot_object);
	}
}
