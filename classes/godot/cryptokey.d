...
{
	enum string _GODOT_internal_name = "CryptoKey";
public:
@nogc nothrow:
	...
	bool opEquals(in CryptoKey other) const { return _godot_object.ptr is other._godot_object.ptr; }
	CryptoKey opAssign(T : typeof(null))(T n) { _godot_object.ptr = null; }
