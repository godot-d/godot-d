...
{
	package(godot) enum string _GODOT_internal_name = "VisualScriptWhile";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in VisualScriptWhile other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) VisualScriptWhile opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of VisualScriptWhile.
	/// Note: use `memnew!VisualScriptWhile` instead.
