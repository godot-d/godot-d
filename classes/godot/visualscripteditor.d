...
{
	package(godot) enum string _GODOT_internal_name = "_VisualScriptEditor";
public:
@nogc nothrow:
	...
	/// 
	pragma(inline, true) bool opEquals(in VisualScriptEditorSingleton other) const
	{ return _godot_object.ptr is other._godot_object.ptr; }
	/// 
	pragma(inline, true) VisualScriptEditorSingleton opAssign(T : typeof(null))(T n)
	{ _godot_object.ptr = n; }
	/// 
	...
	mixin baseCasts;
	/// Construct a new instance of VisualScriptEditorSingleton.
	/// Note: use `memnew!VisualScriptEditorSingleton` instead.
	...
	*/
	void addCustomNode(in String name, in String category, Script script)
	{
		...
		ptrcall!(void)(GDNativeClassBinding.addCustomNode, _godot_object, name, category, script);
	}
	/**
	...
	*/
	...
	{
		checkClassBinding!(typeof(this))();
		ptrcall!(void)(GDNativeClassBinding.removeCustomNode, _godot_object, name, category);
	}
}
...
VisualScriptEditorSingleton VisualScriptEditor()
{
	...
	return VisualScriptEditorSingleton(VisualScriptEditorSingleton.GDNativeClassBinding._singleton);
}
