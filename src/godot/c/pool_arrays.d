...
void godot_pool_byte_array_new_copy(godot_pool_byte_array* p_dest, const godot_pool_byte_array* p_src);
...
ubyte godot_pool_byte_array_get(const godot_pool_byte_array* p_pba, const godot_int p_idx);

godot_int godot_pool_byte_array_size(const godot_pool_byte_array* p_pba);
...
void godot_pool_int_array_new_copy(godot_pool_int_array* p_dest, const godot_pool_int_array* p_src);
...
godot_int godot_pool_int_array_get(const godot_pool_int_array* p_pia, const godot_int p_idx);

godot_int godot_pool_int_array_size(const godot_pool_int_array* p_pia);
...
void godot_pool_real_array_new_copy(godot_pool_real_array* p_dest, const godot_pool_real_array* p_src);
...
godot_real godot_pool_real_array_get(const godot_pool_real_array* p_pra, const godot_int p_idx);

godot_int godot_pool_real_array_size(const godot_pool_real_array* p_pra);
...
void godot_pool_string_array_new_copy(godot_pool_string_array* p_dest, const godot_pool_string_array* p_src);
...
godot_string godot_pool_string_array_get(const godot_pool_string_array* p_psa, const godot_int p_idx);

godot_int godot_pool_string_array_size(const godot_pool_string_array* p_psa);
...
void godot_pool_vector2_array_new_copy(godot_pool_vector2_array* p_dest, const godot_pool_vector2_array* p_src);
...
godot_vector2 godot_pool_vector2_array_get(const godot_pool_vector2_array* p_pv2a, const godot_int p_idx);

godot_int godot_pool_vector2_array_size(const godot_pool_vector2_array* p_pv2a);
...
void godot_pool_vector3_array_new_copy(godot_pool_vector3_array* p_dest, const godot_pool_vector3_array* p_src);
...
godot_vector3 godot_pool_vector3_array_get(const godot_pool_vector3_array* p_pv3a, const godot_int p_idx);

godot_int godot_pool_vector3_array_size(const godot_pool_vector3_array* p_pv3a);
...
void godot_pool_color_array_new_copy(godot_pool_color_array* p_dest, const godot_pool_color_array* p_src);
...
godot_color godot_pool_color_array_get(const godot_pool_color_array* p_pca, const godot_int p_idx);

godot_int godot_pool_color_array_size(const godot_pool_color_array* p_pca);
